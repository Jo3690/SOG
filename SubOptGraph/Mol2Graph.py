...
try:
    ...
    fdefName = os.path.join('./envs/pytorch/share/RDKit/Data','BaseFeatures.fdef') # changes your own envs
    factory = ChemicalFeatures.BuildFeatureFactory(fdefName)
...
possible_atom_type = ['H','B','C', 'N','O','F','Na','Si','P','S','Cl','Ge','Se','Br','Sn','Te','I',] # 
