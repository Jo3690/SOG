...
from Mol2Graph_corrected import Mol2Graph
...
class TADF(InMemoryDataset):
    ...
    def Graph(self,mol1,mol2):
        ...
        return oled(x=x, edge_feats=edge_feats, edge_index=edge_index,global_state = global_state, subgraph_size = subgraph_size, v_shape = v_shape,atom_index=atom_index,e_idx=np.array(e_index,dtype=np.int64))
