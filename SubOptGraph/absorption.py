    ...
    def process(self):
        ...
        if os.path.exists(osp.join(self.raw_dir,f'data_list.pt')):
            ...
            for idx in range(number):
                ...
                '''
                data = Data(x=torch.tensor(d.x,dtype=torch.int64),
...
if __name__ == '__main__':
    ...
    cfg = update_cfg(cfg)
    emission = [line.strip().split('\t') for line in open('./data/absorption/raw/origin_absorption.txt').readlines()]
