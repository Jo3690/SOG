...
class Emitter(InMemoryDataset):
    ...
    def __init__(self, root, subset=False, split='train', transform=None,
                 pre_transform=None, pre_filter=None,file_name=None,test=False,percentage=0.80):
        self.subset = subset
...
if __name__ == '__main__':
    ...
    cfg = update_cfg(cfg)
    plqy = [line.strip().split('\t') for line in open('./data/plqy/raw/origin_plqy.txt').readlines()]
    y = [float(i[2]) for i in plqy]
