...
try:
    ...
    fdefName = os.path.join('./envs/pytorch/share/RDKit/Data','BaseFeatures.fdef')  # changes your own path
    factory = ChemicalFeatures.BuildFeatureFactory(fdefName)
#possible_atom_type = ['H', 'C', 'O', 'N', 'F', 'P', 'S', 'Cl', 'Br', 'I', 'B', 'Si', 'Ge', 'Sn', 'Se','Na','Te']
possible_atom_type = ['H','B','C', 'N','O','F','Na','Si','P','S','Cl','K','Ge','Se','Br','Sn','Te','I','Cs'] # 
...
Vdw = {'H': 1.2, 'He': 1.4, 'Li': 2.2, 'Be': 1.9, 'B': 1.8, 'C': 1.7, 'N': 1.6, 'O': 1.55, 'F': 1.5,
       ...
       'Rh': 2.0, 'Pd': 2.05, 'Ag': 2.1, 'Cd': 2.2, 'In': 2.2, 'Sn': 2.25, 'Sb': 2.2, 'Te': 2.1,'Cs':3.0}
...
def bond_featurizer(mol):
    ...
    for b in mol.GetBonds():
        ...
        b_type.append(is_inring) # 是否是在环中
